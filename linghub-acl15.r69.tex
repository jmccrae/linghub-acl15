...
similarity algorithm and the \textit{Levenshtein} distance string metric. In our
experiments we accepted the highest ranking match as long as it was greater than
the average rank/distance of all highest ranking matches.
