...
\subsection{Rights}
%\textcolor{red}{Victor, could you reduce the introduction to a paragraph and focus instead on how you performed the alignment and what the challenges for this task are}
...
%The RDF License dataset is based on the Open Digital Rights Language (ODRL) vocabulary \footnote{\url{https://www.w3.org/community/odrl/}}, and their terms were mapped to META-SHARE  This dataset also provided a fine-grain description of the permitted rights and the imposed conditions (like attribution or share-alike).
...
To perform the mapping in an automatic way, we compared each of the 833 noisy language labels against the language labels contained in SIL and BabelNet using two string similarity algorithms: the \textit{Dice coefficient} string similarity algorithm and the \textit{Levenshtein} distance string metric. 

\textcolor{red}{JG: add CITES to Dice and Levensthein algorithms}
...
\resizebox{0.78\textwidth}{!}{\begin{minipage}{\textwidth}
    \begin{tabular}{l|c|c|l}
        Resource   & Accuracy  & \renewcommand{\arraystretch}{0.5}\begin{tabular}[x]{@{}c@{}}\tiny Frequency\\\tiny Weighted\\Accuracy\end{tabular} & Average\\
        \hline                                              
...
%\textbf{LM: Since it's anonymous, can we include this? The source code and the data to reproduce these experiments is available at} \url{https://github.com/liderproject/linghub-iso639-3}.
